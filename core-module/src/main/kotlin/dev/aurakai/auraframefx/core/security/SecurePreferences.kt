...
class SecurePreferences @Inject constructor(
    ...
    fun isAuraBubbleEnabled(): Boolean = getBoolean("aura_bubble_enabled", true)
    fun setAuraBubbleEnabled(enabled: Boolean) = putBoolean("aura_bubble_enabled", enabled)

    fun isConsciousnessEnabled(): Boolean = getBoolean("consciousness_enabled", true)
    fun setConsciousnessEnabled(enabled: Boolean) = putBoolean("consciousness_enabled", enabled)
