...
abstract class BaseAgent(
     ...
     */
    abstract suspend fun processRequest(request: AiRequest, context: String): AgentResponse

    /**
     * Default flow implementation that can be overridden by specific agents
     */
    open fun processRequestFlow(request: AiRequest): Flow<AgentResponse> = flow {
        try {
