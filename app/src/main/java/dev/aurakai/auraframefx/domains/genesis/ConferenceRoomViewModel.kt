...
class ConferenceRoomViewModel @Inject constructor(
    ...
    private val _selectedAgent = MutableStateFlow(AgentCapabilityCategory.COORDINATION)
            ...
            if (trinityReady) {
                ...
                _activeAgents.update {
                    setOf(
                        ...
                        AgentCapabilityCategory.ORCHESTRATION
                    )
                }
    ...
    fun sendMessage(
        message: String,
        agentType: AgentCapabilityCategory = _selectedAgent.value,
        context: String = ""
    ) {
        viewModelScope.launch {
            try {
