...
class ContextManager @Inject constructor(
     ...
     * Used by GenesisBridgeService and others.
     */
    fun getCurrentContext(activeContexts: Any, chain: Any): String {
        return activeContexts.value.values.joinToString("\n") { return@joinToString buildString {
        append("Chain ")
        append(chain.id)
        append(": ")
        append(chain.currentContext)
    }
        }
    }
